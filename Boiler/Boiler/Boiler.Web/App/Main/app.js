        ...
        function ($stateProvider, $urlRouterProvider) {
            ...
            if (abp.auth.hasPermission('Pages.Users')) {
                $stateProvider
                    .state('users', {
                        ...
                        menu: 'Users' //Matches to name of 'Users' menu in BoilerNavigationProvider
                    });
            ...
            if (abp.auth.hasPermission('Pages.Tenants')) {
                $stateProvider
                    .state('tenants', {
                        ...
                        menu: 'Tenants' //Matches to name of 'Tenants' menu in BoilerNavigationProvider
                    });
            ...
            $stateProvider
                .state('home', {
                    ...
                    menu: 'Home' //Matches to name of 'Home' menu in BoilerNavigationProvider
                })
                .state('about', {
                    url: '/about',
